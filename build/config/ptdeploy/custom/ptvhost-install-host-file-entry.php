    ...
    protected function setSteps() {
	    ...
	    $this->steps =
	      array(
              ...
              array ( "Logging" => array( "log" => array( "log-message" => "Create our host file entry for our Vice on Wordpress URL"), ) ),
              array ( "HostEditor" => array( "add" => array (
                  "guess" => true,
                  "host-name" => "wordpress.{$this->virtufile->config["vm"]["name"]}.vm",
                  "host-ip" => $this->getCurrentTargetFromPapyrusLocal(),
              ), ), ),
              array ( "Logging" => array( "log" => array( "log-message" => "Create our host file entry for our Vice on Joomla URL"), ) ),
              array ( "HostEditor" => array( "add" => array (
                  "guess" => true,
                  "host-name" => "joomla.{$this->virtufile->config["vm"]["name"]}.vm",
                  "host-ip" => $this->getCurrentTargetFromPapyrusLocal(),
              ), ), ),
              array ( "Logging" => array( "log" => array( "log-message" => "Create our host file entry for our Vice Indexer"), ) ),
              array ( "HostEditor" => array( "add" => array (
                  "guess" => true,
                  "host-name" => "joomla.{$this->virtufile->config["vm"]["name"]}.vm",
                  "host-ip" => $this->getCurrentTargetFromPapyrusLocal(),
